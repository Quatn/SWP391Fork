        ...
        if (service != null) {
            ...
            if (service.equals("add")) {
                ...
                if (owner != null && owner.getRoleId() == 4) {
                    ...
                    {
                        request.setAttribute("notification", "Subject created succefully!");
                    }
                } else {
                    //out.print("User was not an Expert");
                    request.setAttribute("notification", "<p style='color: red'>Error: The user email submitted was not of an Expert</p>");
